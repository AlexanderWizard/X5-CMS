...
return [
    ...
    'cms.templates.field.body_hint' => 'Доступные переменные: $title, $content (тело страницы), $children, $page, $appName. Вывод тела страницы: {!! $content !!}. Инклюд другого шаблона: @partial(\'header\')',
